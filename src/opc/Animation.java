...
public abstract class Animation {
	...
	/**
	 * @return Whether the current timeout has expired.
	 */
	protected boolean isTimedOut() {
		return timeout >= -1 && millis() >= timeout;
	}
	...
	protected void setTimeout(double seconds)  {
		setTimeoutMillis(Math.round(seconds * 1000.0));
	}

	/**
	 * Set the next timeout.
	 *
	 * @param milliseconds Time in thousandths of a second.
	 */
	protected void setTimeoutMillis(long milliseconds)  {
		this.timeout = milliseconds + millis();
	}
